...
class DeviceException extends \Exception
{
    ...
    */
    const MISSING_KEY = "a key is missing in json representing Device";
    const MISSING_VALUE = "a value is missing in json representing Device";
    ...
    const DEVICE_NOT_FOUND = "device does not exit in database";
